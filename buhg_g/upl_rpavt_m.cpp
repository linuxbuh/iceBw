/*$Id: upl_rpavt_m.c,v 1.12 2013/09/26 09:46:58 sasa Exp $*/
/*31.03.2008	31.03.2008	Белых А.И.	upl_rpavt_m.c
...
gboolean   upl_rpavt_v_key_press(GtkWidget *widget,GdkEventKey *event,class upl_rpavt_m_data *data);
void    upl_rpavt_v_vvod(GtkWidget *widget,class upl_rpavt_m_data *data);
void  upl_rpavt_v_knopka(GtkWidget *widget,class upl_rpavt_m_data *data);
void  upl_rpavt_v_e_knopka(GtkWidget *widget,class upl_rpavt_m_data *data);

int upl_rpavt_m_provr(class upl_rpavt_m_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(upl_rpavt_v_key_press),&data);

GtkWidget *label=NULL;
label=gtk_label_new(gettext("Распечатка реестра путевых листов по автомобилям"));
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(upl_rpavt_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(upl_rpavt_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(upl_rpavt_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(upl_rpavt_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_VOD],"clicked",G_CALLBACK(upl_rpavt_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_VOD], "activate",G_CALLBACK(upl_rpavt_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_AVT],"clicked",G_CALLBACK(upl_rpavt_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_AVT], "activate",G_CALLBACK(upl_rpavt_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_POD],"clicked",G_CALLBACK(upl_rpavt_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_POD], "activate",G_CALLBACK(upl_rpavt_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(upl_rpavt_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(upl_rpavt_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(upl_rpavt_v_knopka),&data);
...
/*g_print("upl_rpavt_v_e_knopka knop=%d\n",knop);*/
...
//g_print("upl_rpavt_v_vvod enter=%d\n",enter);
