/*$Id: buhvdzw_m.c,v 1.15 2013/08/25 08:26:32 sasa Exp $*/
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(buhvdzw_m_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(buhvdzw_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(buhvdzw_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(buhvdzw_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(buhvdzw_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(buhvdzw_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(buhvdzw_m_knopka),&data);
...
g_signal_connect(data.knopka[FK5],"clicked",G_CALLBACK(buhvdzw_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(buhvdzw_m_knopka),&data);
