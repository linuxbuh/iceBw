/*$Id: rasttn1w_m.c,v 1.1 2014/01/31 12:12:59 sasa Exp $*/
/*12.07.2015	30.09.2013	Белых А.И.	rasttn1w_m.c
...
void rasttn1w_m_clear(class rasttn1w_m_data *data);
void    rasttn1w_m_vvod(GtkWidget *widget,class rasttn1w_m_data *data);
void  rasttn1w_m_knopka(GtkWidget *widget,class rasttn1w_m_data *data);
gboolean   rasttn1w_m_key_press(GtkWidget *widget,GdkEventKey *event,class rasttn1w_m_data *data);
int rasttn1w_m_zap(class rasttn1w_m_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(rasttn1w_m_key_press),&data);
****************/
g_signal_connect(data.window,"delete_event",G_CALLBACK(gtk_widget_destroy),NULL);
g_signal_connect(data.window,"destroy",G_CALLBACK(gtk_main_quit),NULL);
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(rasttn1w_m_key_press),&data);
...
g_signal_connect(data.entry[E_AVTOPREDP], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_FIO_VOD], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_NOM_PUT_LIST], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_MARKA_AVT], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_GOS_NOMER], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_PUNKT_ZAGR], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_PUNKT_RAZG], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_ZAKAZCHIK], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.entry[E_GOS_NOMER_PRIC], "activate",G_CALLBACK(rasttn1w_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2], "clicked",G_CALLBACK(rasttn1w_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4], "clicked",G_CALLBACK(rasttn1w_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10], "clicked",G_CALLBACK(rasttn1w_m_knopka),&data);
