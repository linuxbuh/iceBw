/*$Id: l_prov_uos.c,v 1.29 2013/12/31 11:49:14 sasa Exp $*/
/*24.05.2016	17.12.2007	Белых А.И.	l_prov_uos.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(prov_uos_key_press),&data);
...
g_signal_connect(data.radiobutton[0], "clicked",G_CALLBACK(prov_uos_radio0),&data);
...
g_signal_connect(data.radiobutton[1], "clicked",G_CALLBACK(prov_uos_radio0),&data);
...
g_signal_connect(data.radiobutton[2], "clicked",G_CALLBACK(prov_uos_radio0),&data);
...
g_signal_connect(data.knopka[FK2], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[SFK2], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[FK3], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[SFK3], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[FK4], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[SFK4], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[FK5], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[SFK5], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[FK9], "clicked",G_CALLBACK(prov_uos_knopka),&data);
...
g_signal_connect(data.knopka[FK10], "clicked",G_CALLBACK(prov_uos_knopka),&data);
