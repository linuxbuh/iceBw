/*$Id: l_sval_p.c,v 1.1 2013/09/05 07:24:33 sasa Exp $*/
/*29.02.2016	01.03.2009	Белых А.И.	l_sval_p.c
...
void l_sval_p_clear(class l_sval_p_data *data);
void    l_sval_p_vvod(GtkWidget *widget,class l_sval_p_data *data);
void  l_sval_p_knopka(GtkWidget *widget,class l_sval_p_data *data);
gboolean   l_sval_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_sval_p_data *data);


int l_sval_p(class l_sval_rek *rek_poi,GtkWidget *wpredok)
{
class l_sval_p_data data;
char strsql[512];
int gor=0,ver=0;
data.rk=rek_poi;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_sval_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_sval_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_sval_p_vvod),&data);
...
g_signal_connect(data.knopka[PFK2],"clicked",G_CALLBACK(l_sval_p_knopka),&data);
...
g_signal_connect(data.knopka[PFK4],"clicked",G_CALLBACK(l_sval_p_knopka),&data);
...
g_signal_connect(data.knopka[PFK10],"clicked",G_CALLBACK(l_sval_p_knopka),&data);
