/*$Id: ukrspdokw_m.c,v 1.14 2013/09/26 09:46:56 sasa Exp $*/
/*29.02.2008	29.02.2008	Белых А.И.	ukrspdokw_m.c
...
gboolean   ukrspdokw_v_key_press(GtkWidget *widget,GdkEventKey *event,class ukrspdokw_m_data *data);
void    ukrspdokw_v_vvod(GtkWidget *widget,class ukrspdokw_m_data *data);
void  ukrspdokw_v_knopka(GtkWidget *widget,class ukrspdokw_m_data *data);
void  ukrspdokw_v_e_knopka(GtkWidget *widget,class ukrspdokw_m_data *data);

int ukrspdokw_m_provr(class ukrspdokw_m_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(ukrspdokw_v_key_press),&data);

GtkWidget *label=NULL;
label=gtk_label_new(gettext("Распечатка списка командировочных документов"));
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(ukrspdokw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(ukrspdokw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(ukrspdokw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(ukrspdokw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KONTR],"clicked",G_CALLBACK(ukrspdokw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KONTR], "activate",G_CALLBACK(ukrspdokw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_ZAT],"clicked",G_CALLBACK(ukrspdokw_v_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_KOD_ZAT],iceb_u_inttochar(E_KOD_ZAT));
gtk_widget_set_tooltip_text(data.knopka_enter[E_KOD_ZAT],gettext("Выбор кода затрат на командировку"));

data.entry[E_KOD_ZAT] = gtk_entry_new();
gtk_box_pack_start (GTK_BOX (hbox[E_KOD_ZAT]), data.entry[E_KOD_ZAT], TRUE, TRUE,1);
g_signal_connect(data.entry[E_KOD_ZAT], "activate",G_CALLBACK(ukrspdokw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_VIDKOM],"clicked",G_CALLBACK(ukrspdokw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_VIDKOM], "activate",G_CALLBACK(ukrspdokw_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(ukrspdokw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(ukrspdokw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(ukrspdokw_v_knopka),&data);
...
/*g_print("ukrspdokw_v_e_knopka knop=%d\n",knop);*/
...
//g_print("ukrspdokw_v_vvod enter=%d\n",enter);
