/*$Id: l_vrint_p.c,v 1.14 2013/08/13 06:10:25 sasa Exp $*/
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_vrint_p_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(l_vrint_p_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(l_vrint_p_vvod),&data);
...
g_signal_connect(data.entry[E_VREMN], "activate",G_CALLBACK(l_vrint_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(l_vrint_p_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(l_vrint_p_vvod),&data);
...
g_signal_connect(data.entry[E_VREMK], "activate",G_CALLBACK(l_vrint_p_vvod),&data);
...
g_signal_connect(data.entry[E_KOMENT], "activate",G_CALLBACK(l_vrint_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_vrint_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_vrint_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_vrint_p_knopka),&data);
