/*$Id: l_gruppod_p.c,v 1.19 2013/08/25 08:26:35 sasa Exp $*/
/*29.02.2016 	05.05.2004	Белых А.И.	l_gruppod_p.c
...
void l_gruppod_p_clear(class l_gruppod_p_data *data);
void    l_gruppod_p_vvod(GtkWidget *widget,class l_gruppod_p_data *data);
void  l_gruppod_p_knopka(GtkWidget *widget,class l_gruppod_p_data *data);
gboolean   l_gruppod_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_gruppod_p_data *data);


int l_gruppod_p(class l_gruppod_rek *rek_poi,GtkWidget *wpredok)
{
class l_gruppod_p_data data;
char strsql[512];
int gor=0,ver=0;
data.rk=rek_poi;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_gruppod_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_gruppod_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_gruppod_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_gruppod_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_gruppod_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_gruppod_p_knopka),&data);
