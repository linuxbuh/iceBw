/*$Id: ukrplcw.c,v 1.3 2013/08/13 06:09:54 sasa Exp $*/
/*13.07.2015	16.10.2012	Белых А.И.	ukrplcw.c
Проверка логической целосности базы в подсистеме "Учёт командировочных расходов"
*/
#include "buhg_g.h"
...
if(metka_prov == 1)
 {
  ...
  sprintf(strsql,"select krb,krn,gkb,gkn from icebuser where login='%s'",iceb_u_getlogin());
...
if(ukrplcw_r(metka_prov,&imaf,&naimf,wpredok) != 0)
 return;
