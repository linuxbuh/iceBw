/*$Id: zar_otrvr_m.c,v 1.13 2013/08/25 08:27:00 sasa Exp $*/
/*13.07.2015	29.11.2006	Белых А.И.	zar_otrvr_m.c
Меню для расчёта отработанного времени по работникам
*/
#include "buhg_g.h"
#include "zar_otrvr.h"
enum
...
gboolean   zar_otrvr_m_key_press(GtkWidget *widget,GdkEventKey *event,class zar_otrvr_m_data *data);
void  zar_otrvr_m_knopka(GtkWidget *widget,class zar_otrvr_m_data *data);
void    zar_otrvr_m_vvod(GtkWidget *widget,class zar_otrvr_m_data *data);


void  zar_otrvr_m_e_knopka(GtkWidget *widget,class zar_otrvr_m_data *data);
...
label=gtk_label_new(gettext("Распечатать свод отработанного времени по работникам"));

gtk_window_set_title(GTK_WINDOW(data.window),strsql);
g_signal_connect(data.window,"delete_event",G_CALLBACK(gtk_widget_destroy),NULL);
g_signal_connect(data.window,"destroy",G_CALLBACK(gtk_main_quit),NULL);
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(zar_otrvr_m_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(zar_otrvr_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(zar_otrvr_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(zar_otrvr_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(zar_otrvr_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_TABNOM],"clicked",G_CALLBACK(zar_otrvr_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_TABNOM], "activate",G_CALLBACK(zar_otrvr_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODR],"clicked",G_CALLBACK(zar_otrvr_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODR], "activate",G_CALLBACK(zar_otrvr_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(zar_otrvr_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(zar_otrvr_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(zar_otrvr_m_knopka),&data);
...
int knop=atoi(gtk_widget_get_name(widget));
//g_print("zar_otrvr_m_knopka knop=%d\n",knop);
...
//g_print("zar_otrvr_m_vvod enter=%d\n",enter);
