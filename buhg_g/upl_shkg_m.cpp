/*$Id: upl_shkg_m.c,v 1.12 2013/09/26 09:46:58 sasa Exp $*/
/*02.04.2008	02.04.2008	Белых А.И.	upl_shkg_m.c
...
gboolean   upl_shkg_v_key_press(GtkWidget *widget,GdkEventKey *event,class upl_shkg_m_data *data);
void    upl_shkg_v_vvod(GtkWidget *widget,class upl_shkg_m_data *data);
void  upl_shkg_v_knopka(GtkWidget *widget,class upl_shkg_m_data *data);
void  upl_shkg_v_e_knopka(GtkWidget *widget,class upl_shkg_m_data *data);

int upl_shkg_m_provr(class upl_shkg_m_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(upl_shkg_v_key_press),&data);

GtkWidget *label=NULL;
label=gtk_label_new(gettext("Распечатка ведомости списания топлива по счетам в киллограммах"));
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(upl_shkg_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(upl_shkg_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(upl_shkg_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(upl_shkg_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_VOD],"clicked",G_CALLBACK(upl_shkg_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_VOD], "activate",G_CALLBACK(upl_shkg_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHET],"clicked",G_CALLBACK(upl_shkg_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHET], "activate",G_CALLBACK(upl_shkg_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_TOP],"clicked",G_CALLBACK(upl_shkg_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_TOP], "activate",G_CALLBACK(upl_shkg_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(upl_shkg_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(upl_shkg_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(upl_shkg_v_knopka),&data);
...
/*g_print("upl_shkg_v_e_knopka knop=%d\n",knop);*/
...
//g_print("upl_shkg_v_vvod enter=%d\n",enter);
