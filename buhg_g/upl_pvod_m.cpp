/*$Id: upl_pvod_m.c,v 1.13 2013/09/26 09:46:58 sasa Exp $*/
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(upl_pvod_v_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(upl_pvod_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(upl_pvod_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(upl_pvod_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(upl_pvod_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_VOD],"clicked",G_CALLBACK(upl_pvod_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_VOD], "activate",G_CALLBACK(upl_pvod_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_AVT],"clicked",G_CALLBACK(upl_pvod_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_AVT], "activate",G_CALLBACK(upl_pvod_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_POD],"clicked",G_CALLBACK(upl_pvod_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_POD], "activate",G_CALLBACK(upl_pvod_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(upl_pvod_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(upl_pvod_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(upl_pvod_v_knopka),&data);
