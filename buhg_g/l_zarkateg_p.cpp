/*$Id:$*/
/*09.03.2017	22.06.2006	Белых А.И.	l_zarkateg_p.cpp
...
void l_zarkateg_p_clear(class l_zarkateg_p_data *data);
void    l_zarkateg_p_vvod(GtkWidget *widget,class l_zarkateg_p_data *data);
void  l_zarkateg_p_knopka(GtkWidget *widget,class l_zarkateg_p_data *data);
gboolean   l_zarkateg_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_zarkateg_p_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_zarkateg_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_zarkateg_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_zarkateg_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2], "clicked",G_CALLBACK(l_zarkateg_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4], "clicked",G_CALLBACK(l_zarkateg_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10], "clicked",G_CALLBACK(l_zarkateg_p_knopka),&data);
