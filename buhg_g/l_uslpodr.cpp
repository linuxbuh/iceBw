/*$Id: l_uslpodr.c,v 1.27 2013/08/25 08:26:43 sasa Exp $*/
/*08.05.2015	17.07.2005	Белых А.И.	l_uslpodr.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(uslpodr_key_press),&data);
...
g_signal_connect(data.knopka[FK2], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[SFK2], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[FK3], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[SFK3], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[FK4], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[FK5], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
g_signal_connect(data.knopka[FK10], "clicked",G_CALLBACK(uslpodr_knopka),&data);
...
renderer = gtk_cell_renderer_text_new ();
gtk_tree_view_insert_column_with_attributes (GTK_TREE_VIEW (treeview),
-1,gettext("Населённый пункт"), renderer,"text", COL_NP,NULL);

renderer = gtk_cell_renderer_text_new ();
gtk_tree_view_insert_column_with_attributes (GTK_TREE_VIEW (treeview),
-1,gettext("Фамилия ответственного"), renderer,"text", COL_FO,NULL);

renderer = gtk_cell_renderer_text_new ();
gtk_tree_view_insert_column_with_attributes (GTK_TREE_VIEW (treeview),
-1,gettext("Должность ответственного"), renderer,"text", COL_DOL,NULL);
