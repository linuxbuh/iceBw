/*$Id: l_uosopr_v.c,v 1.23 2013/10/04 07:27:16 sasa Exp $*/
/*01.03.2016	28.12.2005	Белых А.И.	l_uosopr_v.c
...
void  l_uosopr_v_e_knopka(GtkWidget *widget,class l_uosopr_v_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_uosopr_v_v_key_press),&data);
...
g_signal_connect(data.radiobutton1[0], "clicked",G_CALLBACK(uosopr_radio1_0),&data);
...
g_signal_connect(data.radiobutton1[1], "clicked",G_CALLBACK(uosopr_radio1_1),&data);
...
g_signal_connect(data.radiobutton1[2], "clicked",G_CALLBACK(uosopr_radio1_2),&data);
...
g_signal_connect(data.radiobutton2[0], "clicked",G_CALLBACK(uosopr_radio2_0),&data);
...
g_signal_connect(data.radiobutton2[1], "clicked",G_CALLBACK(uosopr_radio2_1),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_uosopr_v_v_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_uosopr_v_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KONTR],"clicked",G_CALLBACK(l_uosopr_v_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_KONTR],iceb_u_inttochar(E_KONTR));
gtk_widget_set_tooltip_text(data.knopka_enter[E_KONTR],gettext("Выбор контрагента реквизиты которого будут браться в расходные документы"));
...
g_signal_connect(data.entry[E_KONTR], "activate",G_CALLBACK(l_uosopr_v_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_uosopr_v_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_uosopr_v_v_knopka),&data);
...
sprintf(strsql,"update Prov set oper='%s' where oper='%s' and tz=2 and kto='%s'",nkod,skod,ICEB_MP_UOS);
