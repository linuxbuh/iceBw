/*$Id: copdok_m.c,v 1.22 2013/09/26 09:46:47 sasa Exp $*/
/*10.07.2015	30.09.2004	Белых А.И.	copdok_m.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(copdok_m_v_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(copdok_m_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(copdok_m_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KODOP],"clicked",G_CALLBACK(copdok_m_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KODOP], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KONTR],"clicked",G_CALLBACK(copdok_m_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KONTR], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.entry[E_PR], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.entry[E_NOMDOK], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SKLAD],"clicked",G_CALLBACK(copdok_m_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SKLAD], "activate",G_CALLBACK(copdok_m_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(copdok_m_v_knopka),&data);
...
g_signal_connect(data.knopka[FK3],"clicked",G_CALLBACK(copdok_m_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(copdok_m_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(copdok_m_v_knopka),&data);
