/*$Id: rpvnn_piw.c,v 1.9 2014/07/31 07:08:26 sasa Exp $*/
...
if(iceb_u_sravmydat(dn,mn,gn,1,1,2010) >= 0)
  fprintf(ff,"|%*s|%10.2f|",iceb_u_kolbait(82,vsego),vsego,itogo[0]);
else
...
if(iceb_u_sravmydat(dn,mn,gn,1,1,2010) >= 0)
 {
  ...
  fprintf(ff,"|%*s|%10.2f|",iceb_u_kolbait(82,repl),repl,itogo_u[0]);
