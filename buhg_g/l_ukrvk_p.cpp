/*$Id: l_ukrvk_p.c,v 1.11 2013/08/25 08:26:39 sasa Exp $*/
/*01.03.2016	18.02.2008	Белых А.И.	l_ukrvk_p.c
...
void l_ukrvk_p_clear(class l_ukrvk_p_data *data);
void    l_ukrvk_p_vvod(GtkWidget *widget,class l_ukrvk_p_data *data);
void  l_ukrvk_p_knopka(GtkWidget *widget,class l_ukrvk_p_data *data);
gboolean   l_ukrvk_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_ukrvk_p_data *data);


int l_ukrvk_p(class l_ukrvk_rek *rek_poi,GtkWidget *wpredok)
{
class l_ukrvk_p_data data;
char strsql[512];
int gor=0,ver=0;
data.rk=rek_poi;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_ukrvk_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_ukrvk_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_ukrvk_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_ukrvk_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_ukrvk_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_ukrvk_p_knopka),&data);
