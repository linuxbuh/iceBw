/*$Id: zar_sprav_m.c,v 1.14 2013/08/25 08:27:01 sasa Exp $*/
/*25.08.2015	14.11.2006	Белых А.И.	zar_sprav_m.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(zar_sprav_m_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_TABNOM],"clicked",G_CALLBACK(zar_sprav_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_TABNOM], "activate",G_CALLBACK(zar_sprav_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(zar_sprav_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(zar_sprav_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(zar_sprav_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(zar_sprav_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(zar_sprav_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(zar_sprav_m_knopka),&data);
...
g_signal_connect(data.knopka[FK5],"clicked",G_CALLBACK(zar_sprav_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(zar_sprav_m_knopka),&data);
gtk_widget_set_name(data.knopka[FK10],iceb_u_inttochar(FK10));
gtk_box_pack_start(GTK_BOX(hboxknop), data.knopka[FK10], TRUE, TRUE, 0);

gtk_widget_grab_focus(data.entry[0]);

if(data.rk->metka_vr != 2 && data.rk->metka_vr != 3 && data.rk->metka_vr != 6)
