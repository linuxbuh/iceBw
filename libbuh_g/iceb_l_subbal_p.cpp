/*$Id: iceb_l_subbal_p.c,v 1.13 2013/08/25 08:27:06 sasa Exp $*/
/*28.02.2016	28.04.2007	Белых А.И.	iceb_l_subbal_p.c
...
class iceb_l_subbal_p_data
 {
  ...
  iceb_l_subbal_p_data() //Конструктор
   {
    kl_shift=0;
    voz=1;
   }
...
void iceb_l_subbal_p_clear(class iceb_l_subbal_p_data *data);
void    iceb_l_subbal_p_vvod(GtkWidget *widget,class iceb_l_subbal_p_data *data);
void  iceb_l_subbal_p_knopka(GtkWidget *widget,class iceb_l_subbal_p_data *data);
gboolean   iceb_l_subbal_p_key_press(GtkWidget *widget,GdkEventKey *event,class iceb_l_subbal_p_data *data);


int iceb_l_subbal_p(class iceb_l_subbal_rek *rek_poi,GtkWidget *wpredok)
{
class iceb_l_subbal_p_data data;
char strsql[512];
int gor=0,ver=0;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(iceb_l_subbal_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(iceb_l_subbal_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(iceb_l_subbal_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(iceb_l_subbal_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(iceb_l_subbal_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(iceb_l_subbal_p_knopka),&data);
