/*$Id: l_mater_zkm.c,v 1.14 2013/08/25 08:26:37 sasa Exp $*/
/*11.07.2015	19.05.2004	Белых А.И.	l_mater_zkm.c
...
sprintf(strsql,"%s %s",iceb_get_namesystem(),gettext("Замена одного кода на другой с удалением первого"));
...
g_idle_add((GSourceFunc)mater_zkm1,&data);
