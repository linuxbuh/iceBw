/*$Id: l_tippl_p.c,v 1.14 2013/08/25 08:26:39 sasa Exp $*/
/*01.03.2016	12.05.2006	Белых А.И.	l_tippl_p.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(tipplp_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(tipplp_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(tipplp_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(tipplp_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(tipplp_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(tipplp_p_knopka),&data);
