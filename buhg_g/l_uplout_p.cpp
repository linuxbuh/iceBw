/*$Id: l_uplout_p.c,v 1.10 2013/08/25 08:26:42 sasa Exp $*/
/*02.03.2016	05.03.2008	Белых А.И.	l_uplout_p.c
...
void l_uplout_p_clear(class l_uplout_p_data *data);
void    l_uplout_p_vvod(GtkWidget *widget,class l_uplout_p_data *data);
void  l_uplout_p_knopka(GtkWidget *widget,class l_uplout_p_data *data);
gboolean   l_uplout_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_uplout_p_data *data);


int l_uplout_p(class l_uplout_rek *rek_poi,GtkWidget *wpredok)
{
class l_uplout_p_data data;
char strsql[512];
int gor=0,ver=0;
data.rk=rek_poi;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_uplout_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_uplout_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_uplout_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_uplout_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_uplout_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_uplout_p_knopka),&data);
