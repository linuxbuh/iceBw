/*$Id: iceb_l_forop_p.c,v 1.16 2013/08/25 08:27:05 sasa Exp $*/
/*28.02.2016	10.05.2004	Белых А.И.	iceb_l_forop_p.c
Меню для ввода реквизитов поиска 
*/
#include "iceb_libbuh.h"
#include "iceb_l_forop.h"

class iceb_l_forop_p_data
 {
  public:
  ...
  iceb_l_forop_p_data() //Конструктор
   {
    kl_shift=0;
    voz=1;
   }
...
void forop_p_clear(class iceb_l_forop_p_data *data);
void    forop_p_vvod(GtkWidget *widget,class iceb_l_forop_p_data *data);
void  forop_p_knopka(GtkWidget *widget,class iceb_l_forop_p_data *data);
gboolean   forop_p_key_press(GtkWidget *widget,GdkEventKey *event,class iceb_l_forop_p_data *data);
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(forop_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(forop_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(forop_p_vvod),&data);
...
g_signal_connect(data.knopka[PFK2],"clicked",G_CALLBACK(forop_p_knopka),&data);
...
g_signal_connect(data.knopka[PFK4],"clicked",G_CALLBACK(forop_p_knopka),&data);
...
g_signal_connect(data.knopka[PFK10],"clicked",G_CALLBACK(forop_p_knopka),&data);
