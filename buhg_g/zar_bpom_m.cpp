/*$Id: zar_bpom_m.c,v 1.13 2013/08/25 08:27:00 sasa Exp $*/
/*13.07.2015	08.12.2006	Белых А.И.	zar_bpom_m.c
Меню для распечатки списка работников имеющих благотворительную помощь
*/
#include "buhg_g.h"
#include "zar_bpom.h"
enum
...
gboolean   zar_bpom_m_key_press(GtkWidget *widget,GdkEventKey *event,class zar_bpom_m_data *data);
void  zar_bpom_m_knopka(GtkWidget *widget,class zar_bpom_m_data *data);
void    zar_bpom_m_vvod(GtkWidget *widget,class zar_bpom_m_data *data);


void  zar_bpom_m_e_knopka(GtkWidget *widget,class zar_bpom_m_data *data);
...
label=gtk_label_new(gettext("Распечатать список работников, которым начислялась благотворительная помощь"));

gtk_window_set_title(GTK_WINDOW(data.window),strsql);
g_signal_connect(data.window,"delete_event",G_CALLBACK(gtk_widget_destroy),NULL);
g_signal_connect(data.window,"destroy",G_CALLBACK(gtk_main_quit),NULL);
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(zar_bpom_m_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(zar_bpom_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(zar_bpom_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(zar_bpom_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(zar_bpom_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_TABNOM],"clicked",G_CALLBACK(zar_bpom_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_TABNOM], "activate",G_CALLBACK(zar_bpom_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODR],"clicked",G_CALLBACK(zar_bpom_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODR], "activate",G_CALLBACK(zar_bpom_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_KAT],"clicked",G_CALLBACK(zar_bpom_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_KAT], "activate",G_CALLBACK(zar_bpom_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(zar_bpom_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(zar_bpom_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(zar_bpom_m_knopka),&data);
...
int knop=atoi(gtk_widget_get_name(widget));
//g_print("zar_bpom_m_knopka knop=%d\n",knop);
...
//g_print("zar_bpom_m_vvod enter=%d\n",enter);
