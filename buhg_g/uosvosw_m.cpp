/*$Id: uosvosw_m.c,v 1.14 2013/09/26 09:46:57 sasa Exp $*/
/*14.01.2008	14.01.2008	Белых А.И.	uosvosw_m.c
...
gboolean   uosvosw_v_key_press(GtkWidget *widget,GdkEventKey *event,class uosvosw_m_data *data);
void    uosvosw_v_vvod(GtkWidget *widget,class uosvosw_m_data *data);
void  uosvosw_v_knopka(GtkWidget *widget,class uosvosw_m_data *data);
void  uosvosw_v_e_knopka(GtkWidget *widget,class uosvosw_m_data *data);

int uosvosw_m_provr(class uosvosw_m_data *data);

extern SQL_baza bd;

int uosvosw_m(int metka_r, /*0-налоговый учёт 1-бух.учёт*/
class uosvosw_data *rek_ras)
{
char strsql[512];

class uosvosw_m_data data;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(uosvosw_v_key_press),&data);

GtkWidget *label=NULL;
if(metka_r == 0)
 label=gtk_label_new(gettext("Распечатать ведомость остаточной стоимости (налоговый учёт)"));
if(metka_r == 1)
 label=gtk_label_new(gettext("Распечатать ведомость остаточной стоимости (бух. учёт)"));
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_GRUPA_NU],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_GRUPA_NU], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_GRUPA_BU],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_GRUPA_BU], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_MAT_OT],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_MAT_OT], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODR],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODR], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHETU],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHETU], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_HZT],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_HZT], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_HAU],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_HAU], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_INNOM],"clicked",G_CALLBACK(uosvosw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_INNOM], "activate",G_CALLBACK(uosvosw_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(uosvosw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(uosvosw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(uosvosw_v_knopka),&data);
...
/*g_print("uosvosw_v_e_knopka knop=%d\n",knop);*/
...
//g_print("uosvosw_v_vvod enter=%d\n",enter);
