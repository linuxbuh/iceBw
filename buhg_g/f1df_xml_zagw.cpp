/*$Id: f1df_xml_zagw.c,v 1.15 2014/04/30 06:14:58 sasa Exp $*/
/*19.12.2014	23.04.2007	Белых А.И.	f1df_xml_zagw.c
...
/****************
if(iceb_openxml(1,mn,god,dk,mk,god,imaf_xml,"J05","001","04",1,&period_type,&rek_fil_xml,ff_xml,wpredok) != 0)
 return;

iceb_rnn_sap_xml(mn,god,mk,"J05","001",4,1,"J0500104.XSD",period_type,&rek_fil_xml,*ff_xml);
*********************/
if(iceb_openxml(1,mn,god,dk,mk,god,imaf_xml,iceb_getkoddok(1,mn,god,6),1,&period_type,&rek_fil_xml,ff_xml,wpredok) != 0)
 return;

iceb_rnn_sap_xml(mn,god,mk,iceb_getkoddok(1,mn,god,6),1,period_type,&rek_fil_xml,*ff_xml);
