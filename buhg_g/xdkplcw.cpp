/*$Id: xdkplcw.c,v 1.3 2013/08/13 06:09:58 sasa Exp $*/
/*13.07.2015	16.10.2012	Белых А.И.	xdkplcw.c
Проверка логической целосности базы в подсистеме "Платёжные документы"
*/
#include "buhg_g.h"
...
if(metka_prov == 1)
 {
  ...
  sprintf(strsql,"select pdb,pdn,gkb,gkn from icebuser where login='%s'",iceb_u_getlogin());
...
if(xdkplcw_r(metka_prov,&imaf,&naimf,wpredok) != 0)
 return;
