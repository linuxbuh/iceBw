/*$Id: uosplcw.c,v 1.3 2013/08/13 06:09:55 sasa Exp $*/
/*13.07.2015	11.10.2012	Белых А.И.	uosplcw.c
Проверка логической целосности базы в подсистеме "Учёт основных средств"
*/
#include "buhg_g.h"
...
if(metka_prov == 1)
 {
  ...
  sprintf(strsql,"select osb,osn,gkb,gkn from icebuser where login='%s'",iceb_u_getlogin());
...
if(uosplcw_r(metka_prov,&imaf,&naimf,wpredok) != 0)
 return;
