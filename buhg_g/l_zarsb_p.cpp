/*$Id: l_zarsb_p.c,v 1.9 2013/08/25 08:26:47 sasa Exp $*/
/*03.03.2016	10.09.2009	Белых А.И.	l_zarsb_p.c
...
void l_zarsb_p_clear(class l_zarsb_p_data *data);
void    l_zarsb_p_vvod(GtkWidget *widget,class l_zarsb_p_data *data);
void  l_zarsb_p_knopka(GtkWidget *widget,class l_zarsb_p_data *data);
gboolean   l_zarsb_p_key_press(GtkWidget *widget,GdkEventKey *event,class l_zarsb_p_data *data);


int l_zarsb_p(class l_zarsb_rek *rek_poi,GtkWidget *wpredok)
{
class l_zarsb_p_data data;
char strsql[512];
int gor=0,ver=0;
data.rk=rek_poi;
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_zarsb_p_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_zarsb_p_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_zarsb_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_zarsb_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_zarsb_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_zarsb_p_knopka),&data);
