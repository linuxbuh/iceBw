/*$Id: l_taxitel_v.c,v 1.6 2013/08/13 06:10:24 sasa Exp $*/
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_taxitel_v_key_press),&data);
...
g_signal_connect(data.entry[E_KOD], "activate",G_CALLBACK(l_taxitel_v_vvod),&data);
...
g_signal_connect(data.entry[E_NAIM], "activate",G_CALLBACK(l_taxitel_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_taxitel_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_taxitel_v_knopka),&data);
