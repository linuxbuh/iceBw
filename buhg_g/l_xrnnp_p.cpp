/*$Id: l_xrnnp_p.c,v 1.15 2014/02/28 05:20:59 sasa Exp $*/
/*02.03.2016	15.04.2008	Белых А.И.	l_xrnnp_p.c
  ...
  void read_rek()
   {
    ...
    rk->datavnn.new_plus(gtk_entry_get_text(GTK_ENTRY(entry[E_DATAVNN])));
    rk->datavnk.new_plus(gtk_entry_get_text(GTK_ENTRY(entry[E_DATAVNK])));
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_xrnnp_p_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.entry[E_NNN], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.entry[E_NOMDOK], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.entry[E_INN], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_NAIM_KONTR],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_NAIM_KONTR], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.entry[E_KOMENT], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_GR],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_GR], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_OP],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_OP], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODS],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODS], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAVNN],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAVNN], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
data.knopka_enter[E_DATAVNK]=gtk_button_new_with_label(strsql);
gtk_box_pack_start (GTK_BOX (hbox[E_DATAVNK]), data.knopka_enter[E_DATAVNK], FALSE, FALSE,1);
g_signal_connect(data.knopka_enter[E_DATAVNK],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_DATAVNK],iceb_u_inttochar(E_DATAVNK));
gtk_widget_set_tooltip_text(data.knopka_enter[E_DATAVNK],gettext("Выбор даты"));

data.entry[E_DATAVNK] = gtk_entry_new ();
gtk_entry_set_max_length(GTK_ENTRY(data.entry[E_DATAVNK]),10);
gtk_box_pack_start (GTK_BOX (hbox[E_DATAVNK]), data.entry[E_DATAVNK], TRUE, TRUE,1);
g_signal_connect(data.entry[E_DATAVNK], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
gtk_entry_set_text(GTK_ENTRY(data.entry[E_DATAVNK]),data.rk->datavnk.ravno());
gtk_widget_set_name(data.entry[E_DATAVNK],iceb_u_inttochar(E_DATAVNK));
...
g_signal_connect(data.knopka_enter[E_VIDDOK],"clicked",G_CALLBACK(l_xrnnp_p_e_knopka),&data);
...
gtk_entry_set_max_length(GTK_ENTRY(data.entry[E_VIDDOK]),7);
gtk_box_pack_start (GTK_BOX (hbox[E_VIDDOK]), data.entry[E_VIDDOK], TRUE, TRUE,1);
g_signal_connect(data.entry[E_VIDDOK], "activate",G_CALLBACK(l_xrnnp_p_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_xrnnp_p_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(l_xrnnp_p_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_xrnnp_p_knopka),&data);
