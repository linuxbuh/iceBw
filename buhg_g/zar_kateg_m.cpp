/*$Id: zar_kateg_m.c,v 1.18 2013/08/25 08:27:00 sasa Exp $*/
/*13.07.2015	14.11.2006	Белых А.И.	zar_kateg_m.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(zar_kateg_m_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_TABNOM],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_TABNOM], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_NAH],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_NAH], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_UD],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_UD], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_PODR],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_PODR], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_KAT],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_KAT], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHET],"clicked",G_CALLBACK(zar_kateg_m_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHET], "activate",G_CALLBACK(zar_kateg_m_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(zar_kateg_m_knopka),&data);
...
g_signal_connect(data.knopka[FK3],"clicked",G_CALLBACK(zar_kateg_m_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(zar_kateg_m_knopka),&data);
...
g_signal_connect(data.knopka[FK5],"clicked",G_CALLBACK(zar_kateg_m_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(zar_kateg_m_knopka),&data);
