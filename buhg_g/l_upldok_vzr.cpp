/*$Id: l_upldok_vzr.c,v 1.13 2013/08/25 08:26:42 sasa Exp $*/
/*01.03.2016	23.03.2008	Белых А.И.	l_upldok_vzr.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(l_upldok_vzr_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_KOD_TOP],"clicked",G_CALLBACK(l_upldok_vzr_e_knopka),&data);
...
g_signal_connect(data.entry[E_KOD_TOP], "activate",G_CALLBACK(l_upldok_vzr_vvod),&data);
...
g_signal_connect(data.entry[E_KOLIH], "activate",G_CALLBACK(l_upldok_vzr_vvod),&data);
...
g_signal_connect(data.entry[E_KOMENT], "activate",G_CALLBACK(l_upldok_vzr_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(l_upldok_vzr_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(l_upldok_vzr_knopka),&data);
