/*$Id: opssw_m.c,v 1.20 2013/09/26 09:46:52 sasa Exp $*/
/*12.07.2015	09.05.2005	Белых А.И.	opssw_m.c
...
g_signal_connect_after(data.window,"key_press_event",G_CALLBACK(opssw_v_key_press),&data);
...
g_signal_connect(data.knopka_enter[E_DATAN],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAN], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_DATAK],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_DATAK], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SKLAD],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SKLAD], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KODGRMAT],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
gtk_widget_set_name(data.knopka_enter[E_KODGRMAT],iceb_u_inttochar(E_KODGRMAT));
gtk_widget_set_tooltip_text(data.knopka_enter[E_KODGRMAT],gettext("Выбор группы"));

data.entry[E_KODGRMAT] = gtk_entry_new();
gtk_box_pack_start (GTK_BOX (hbox[E_KODGRMAT]), data.entry[E_KODGRMAT], TRUE, TRUE, 0);
g_signal_connect(data.entry[E_KODGRMAT], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KODMAT],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KODMAT], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHET_UH],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHET_UH], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_SHET_SP],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_SHET_SP], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KODOP],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KODOP], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka_enter[E_KONTR],"clicked",G_CALLBACK(opssw_v_e_knopka),&data);
...
g_signal_connect(data.entry[E_KONTR], "activate",G_CALLBACK(opssw_v_vvod),&data);
...
g_signal_connect(data.knopka[FK2],"clicked",G_CALLBACK(opssw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK4],"clicked",G_CALLBACK(opssw_v_knopka),&data);
...
g_signal_connect(data.knopka[FK10],"clicked",G_CALLBACK(opssw_v_knopka),&data);
